        ...
        <div className='container home-page'>
            ...
            <div className='skill-item'>
                <div className='js-icon'>
                    <li className='list-item'><img className="home-icon" src={js} alt="" /></li>
                </div>
                <div className='react-icon'>
                    <li className='list-item'><img className="home-icon" src={react} alt="" /></li>
                </div>
                <div className='tailwind-icon'>
                    <li className='list-item'><img className="home-icon" src={tailwind} alt="" /></li>
