            ...
            <div className='skills-works'>
                ...
                <div className='works-part'>
                    ...
                    <div className='card-group'>
                        {
                            results?.map((item) => (
                                <div data-aos="zoom-in" data-aos-duration="1500" key={item?.id} className='card'>
                                    <img className='card-img' src={item?.thumbnail} alt="" />
                                    <h2 className='card-text'>{item?.description}</h2>
                                    <div className='icon-container'>
                                        <Link target="_blank" to={item?.live}><FontAwesomeIcon className='card-icon' icon={faEye} /></Link>
                                        <Link target="_blank" to={item?.client}><FontAwesomeIcon className='card-icon' icon={faGithub} /></Link>
                                        <Link target="_blank" to={item?.server}><FontAwesomeIcon className='card-icon' icon={faCode} /></Link>
                                    </div>
                                </div>
                            ))
                        }
